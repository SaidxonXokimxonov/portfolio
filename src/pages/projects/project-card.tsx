...
export const ProjectCard = ({ project }: { project: Project }) => {
  ...
  return (
    <div className="group bg-slate-800 rounded-xl overflow-hidden shadow-lg transition-all duration-500 hover:shadow-xl hover:scale-[1.02] hover:bg-slate-700">
      <div className="relative h-48 overflow-hidden">
        <div className="bg-gray-200 rounded-se-xl w-full h-full">
          <img className="size-full" src={project.img} alt="" />
        </div>
